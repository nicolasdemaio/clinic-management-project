...
const HomeView = () => {
  ...
  const ToggleMenu = (event) => {
    ...
    if (reference && reference.startsWith('#')) {
      document
        .getElementById(reference.replace('#', ''))
      ...
      <header className='mainstart'>
        <nav className={navState}>
          ...
          <div id='menu'>
            <div
              id='menu-toggle'
              className={showMenu ? 'showMenu' : 'closeMenu'}
              onClick={ToggleMenu}
            >
              <div id='menu-icon'>
            ...
            <ul
              className={showMenu ? 'closeMenu' : 'showMenu'}
              style={{ top: { ultop } }}
            >
              <li onClick={ToggleMenu}>
                <a href='#section00'>Conocenos</a>
              </li>
              <li onClick={ToggleMenu}>
                <a href='#section01'>Cartilla medica</a>
              </li>
              <li onClick={ToggleMenu}>
                <a href='#section02'>Gestion</a>
              </li>
              <li onClick={ToggleMenu}>
