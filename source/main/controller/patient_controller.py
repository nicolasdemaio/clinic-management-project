# Controller;
# Se encarga de recibir peticiones HTTP [Post, Get, Put, Delete] y
# de retornar respuestas (Json; con Jsonify) con cuerpo y código de error.

patient_service = PatientService(PatientController())
